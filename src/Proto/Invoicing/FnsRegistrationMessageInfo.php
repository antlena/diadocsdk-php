...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.FnsRegistrationMessageInfo
 */
class FnsRegistrationMessageInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\FnsRegistrationMessageInfo) {
