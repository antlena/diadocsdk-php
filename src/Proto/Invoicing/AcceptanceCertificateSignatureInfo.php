...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Invoicing.AcceptanceCertificateSignatureInfo
 */
class AcceptanceCertificateSignatureInfo extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setOfficial(\Antlena\SDK\Diadoc\Proto\Invoicing\Official $value = null)
    {
        $this->Official = $value;
    }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\AcceptanceCertificateSignatureInfo) {
