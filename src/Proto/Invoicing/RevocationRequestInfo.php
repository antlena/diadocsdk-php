...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.RevocationRequestInfo
 */
class RevocationRequestInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\RevocationRequestInfo) {
