...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.OtherIssuer
 */
class OtherIssuer extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->TransferSurname === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\OtherIssuer#TransferSurname" (tag 6) is required but has no value.');
        }

        if ($this->TransferFirstName === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\OtherIssuer#TransferFirstName" (tag 7) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\OtherIssuer) {
