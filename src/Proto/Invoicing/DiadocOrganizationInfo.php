...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.DiadocOrganizationInfo
 */
class DiadocOrganizationInfo extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setOrgInfo(\Antlena\SDK\Diadoc\Proto\Invoicing\OrganizationInfo $value = null)
    {
        $this->OrgInfo = $value;
    }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\DiadocOrganizationInfo) {
