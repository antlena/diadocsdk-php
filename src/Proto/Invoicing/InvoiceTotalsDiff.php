...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.InvoiceTotalsDiff
 */
class InvoiceTotalsDiff extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Total === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\InvoiceTotalsDiff#Total" (tag 3) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\InvoiceTotalsDiff) {
