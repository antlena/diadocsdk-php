...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.Torg12Item
 */
class Torg12Item extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Name === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Torg12Item#Name" (tag 1) is required but has no value.');
        }

        if ($this->UnitName === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Torg12Item#UnitName" (tag 7) is required but has no value.');
        }

        if ($this->Quantity === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Torg12Item#Quantity" (tag 12) is required but has no value.');
        }

        if ($this->TaxRate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Torg12Item#TaxRate" (tag 14) is required but has no value.');
        }

        if ($this->Subtotal === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Torg12Item#Subtotal" (tag 17) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\Torg12Item) {
