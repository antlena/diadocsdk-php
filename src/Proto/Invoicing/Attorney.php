...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.Attorney
 */
class Attorney extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setIssuerPerson(\Antlena\SDK\Diadoc\Proto\Invoicing\Official $value = null)
    {
     ...
     * @param \Antlena\SDK\Diadoc\Proto\Invoicing\Official $value
     */
    public function setRecipientPerson(\Antlena\SDK\Diadoc\Proto\Invoicing\Official $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\Attorney) {
