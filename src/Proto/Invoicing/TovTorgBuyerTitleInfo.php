...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.TovTorgBuyerTitleInfo
 */
class TovTorgBuyerTitleInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentCreator === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\TovTorgBuyerTitleInfo#DocumentCreator" (tag 1) is required but has no value.');
        }

        if ($this->OperationContent === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\TovTorgBuyerTitleInfo#OperationContent" (tag 4) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\TovTorgBuyerTitleInfo) {
