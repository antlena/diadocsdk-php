...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.Employee
 */
class Employee extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->EmployeePosition === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Employee#EmployeePosition" (tag 1) is required but has no value.');
        }

        if ($this->TransferSurname === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Employee#TransferSurname" (tag 4) is required but has no value.');
        }

        if ($this->TransferFirstName === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Employee#TransferFirstName" (tag 5) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\Employee) {
