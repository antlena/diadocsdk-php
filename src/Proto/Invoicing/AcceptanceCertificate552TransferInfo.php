...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Invoicing.AcceptanceCertificate552TransferInfo
 */
class AcceptanceCertificate552TransferInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->OperationInfo === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\AcceptanceCertificate552TransferInfo#OperationInfo" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\AcceptanceCertificate552TransferInfo) {
