...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.OrganizationInfo
 */
class OrganizationInfo extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setAddress(\Antlena\SDK\Diadoc\Proto\Address $value)
    {
        $this->Address = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Name === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\OrganizationInfo#Name" (tag 1) is required but has no value.');
        }

        if ($this->Address === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\OrganizationInfo#Address" (tag 4) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\OrganizationInfo) {
