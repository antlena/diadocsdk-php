...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Invoicing.AcceptanceCertificate552WorkItem
 */
class AcceptanceCertificate552WorkItem extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\AcceptanceCertificate552WorkItem) {
