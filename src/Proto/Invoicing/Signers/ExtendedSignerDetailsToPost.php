...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Invoicing.Signers.ExtendedSignerDetailsToPost
 */
class ExtendedSignerDetailsToPost extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignerType === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Signers\\ExtendedSignerDetailsToPost#SignerType" (tag 3) is required but has no value.');
        }

        if ($this->SignerPowers === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Signers\\ExtendedSignerDetailsToPost#SignerPowers" (tag 5) is required but has no value.');
        }

        if ($this->SignerStatus === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\Signers\\ExtendedSignerDetailsToPost#SignerStatus" (tag 6) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\Signers\ExtendedSignerDetailsToPost) {
