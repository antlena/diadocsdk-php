...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.Shipper
 */
class Shipper extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setOrgInfo(\Antlena\SDK\Diadoc\Proto\Invoicing\Organizations\ExtendedOrganizationInfo $value = null)
    {
        $this->OrgInfo = $value;
    }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\Shipper) {
