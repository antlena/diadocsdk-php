...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.InvoiceCorrectionRequestInfo
 */
class InvoiceCorrectionRequestInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ErrorMessage === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\InvoiceCorrectionRequestInfo#ErrorMessage" (tag 1) is required but has no value.');
        }

        if ($this->Signer === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\InvoiceCorrectionRequestInfo#Signer" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\InvoiceCorrectionRequestInfo) {
