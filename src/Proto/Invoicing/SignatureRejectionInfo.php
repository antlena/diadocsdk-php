...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.SignatureRejectionInfo
 */
class SignatureRejectionInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Signer === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\SignatureRejectionInfo#Signer" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\SignatureRejectionInfo) {
