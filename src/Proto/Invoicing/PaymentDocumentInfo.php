...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.PaymentDocumentInfo
 */
class PaymentDocumentInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\PaymentDocumentInfo#DocumentDate" (tag 1) is required but has no value.');
        }

        if ($this->DocumentNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\PaymentDocumentInfo#DocumentNumber" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\PaymentDocumentInfo) {
