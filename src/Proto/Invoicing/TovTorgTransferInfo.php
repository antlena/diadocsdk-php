...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.TovTorgTransferInfo
 */
class TovTorgTransferInfo extends \Protobuf\AbstractMessage
{
     ...
     */
    public function addWaybills(\Antlena\SDK\Diadoc\Proto\Invoicing\Waybill $value)
    {
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->OperationInfo === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\TovTorgTransferInfo#OperationInfo" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\TovTorgTransferInfo) {
