...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Invoicing.AcceptanceCertificate552BuyerTitleInfo
 */
class AcceptanceCertificate552BuyerTitleInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentCreator === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\AcceptanceCertificate552BuyerTitleInfo#DocumentCreator" (tag 2) is required but has no value.');
        }

        if ($this->OperationContent === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\AcceptanceCertificate552BuyerTitleInfo#OperationContent" (tag 6) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\AcceptanceCertificate552BuyerTitleInfo) {
