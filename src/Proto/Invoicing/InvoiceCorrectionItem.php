...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Invoicing.InvoiceCorrectionItem
 */
class InvoiceCorrectionItem extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Product === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\InvoiceCorrectionItem#Product" (tag 1) is required but has no value.');
        }

        if ($this->OriginalValues === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\InvoiceCorrectionItem#OriginalValues" (tag 2) is required but has no value.');
        }

        if ($this->CorrectedValues === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Invoicing\\InvoiceCorrectionItem#CorrectedValues" (tag 3) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Invoicing\InvoiceCorrectionItem) {
