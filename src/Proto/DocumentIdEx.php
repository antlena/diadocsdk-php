...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.DocumentIdEx
 */
class DocumentIdEx extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->MessageId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\DocumentIdEx#MessageId" (tag 1) is required but has no value.');
        }

        if ($this->EntityId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\DocumentIdEx#EntityId" (tag 2) is required but has no value.');
        }

        if ($this->BoxId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\DocumentIdEx#BoxId" (tag 3) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\DocumentIdEx) {
