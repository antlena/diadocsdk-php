...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Recognition.RecognizedInvoice
 */
class RecognizedInvoice extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->MetadataJson === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Recognition\\RecognizedInvoice#MetadataJson" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Recognition\RecognizedInvoice) {
