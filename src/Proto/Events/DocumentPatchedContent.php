...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.DocumentPatchedContent
 */
class DocumentPatchedContent extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\DocumentPatchedContent#DocumentId" (tag 1) is required but has no value.');
        }

        if ($this->PatchedContentId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\DocumentPatchedContent#PatchedContentId" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\DocumentPatchedContent) {
