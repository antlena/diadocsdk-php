...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ResolutionRequestDenialInfo
 */
class ResolutionRequestDenialInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Author === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRequestDenialInfo#Author" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ResolutionRequestDenialInfo) {
