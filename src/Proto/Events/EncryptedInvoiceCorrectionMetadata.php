...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Events.EncryptedInvoiceCorrectionMetadata
 */
class EncryptedInvoiceCorrectionMetadata extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setOriginalInvoiceDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value)
    {
     ...
     * @param \Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value
     */
    public function setOriginalInvoiceRevisionDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
     ...
     * @param \Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value
     */
    public function setInvoiceCorrectionRevisionDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->OriginalInvoiceDateAndNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\EncryptedInvoiceCorrectionMetadata#OriginalInvoiceDateAndNumber" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\EncryptedInvoiceCorrectionMetadata) {
