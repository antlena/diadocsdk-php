...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ResolutionRequestDenialAttachment
 */
class ResolutionRequestDenialAttachment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->InitialResolutionRequestId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRequestDenialAttachment#InitialResolutionRequestId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ResolutionRequestDenialAttachment) {
