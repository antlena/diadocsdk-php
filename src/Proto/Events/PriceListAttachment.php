...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.PriceListAttachment
 */
class PriceListAttachment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\PriceListAttachment#SignedContent" (tag 1) is required but has no value.');
        }

        if ($this->FileName === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\PriceListAttachment#FileName" (tag 2) is required but has no value.');
        }

        if ($this->DocumentDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\PriceListAttachment#DocumentDate" (tag 7) is required but has no value.');
        }

        if ($this->DocumentNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\PriceListAttachment#DocumentNumber" (tag 8) is required but has no value.');
        }

        if ($this->PriceListEffectiveDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\PriceListAttachment#PriceListEffectiveDate" (tag 9) is required but has no value.');
        }

        if ($this->ContractDocumentDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\PriceListAttachment#ContractDocumentDate" (tag 10) is required but has no value.');
        }

        if ($this->ContractDocumentNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\PriceListAttachment#ContractDocumentNumber" (tag 11) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\PriceListAttachment) {
