...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ResolutionRouteRemovalInfo
 */
class ResolutionRouteRemovalInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->RouteId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteRemovalInfo#RouteId" (tag 1) is required but has no value.');
        }

        if ($this->Author === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteRemovalInfo#Author" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ResolutionRouteRemovalInfo) {
