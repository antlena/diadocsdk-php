...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ResolutionRouteAssignmentInfo
 */
class ResolutionRouteAssignmentInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->RouteId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteAssignmentInfo#RouteId" (tag 1) is required but has no value.');
        }

        if ($this->Author === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteAssignmentInfo#Author" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ResolutionRouteAssignmentInfo) {
