...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.DraftDocumentToPatch
 */
class DraftDocumentToPatch extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\DraftDocumentToPatch#DocumentId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\DraftDocumentToPatch) {
