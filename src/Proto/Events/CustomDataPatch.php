...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.CustomDataPatch
 */
class CustomDataPatch extends \Protobuf\AbstractMessage
{
     ...
     * Set 'Operation' value
     *
     * @param \Antlena\SDK\Diadoc\Proto\Events\CustomDataPatchOperation $value
     */
    public function setOperation(\Antlena\SDK\Diadoc\Proto\Events\CustomDataPatchOperation $value)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_REQUIRED(),
                    'type_name' => '.Antlena.SDK.Diadoc.Proto.Events.CustomDataPatchOperation'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 3,
                    'name' => 'Key',
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentEntityId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\CustomDataPatch#ParentEntityId" (tag 1) is required but has no value.');
        }

        if ($this->Operation === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\CustomDataPatch#Operation" (tag 2) is required but has no value.');
        }

        if ($this->Key === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\CustomDataPatch#Key" (tag 3) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->Operation = \Antlena\SDK\Diadoc\Proto\Events\CustomDataPatchOperation::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\CustomDataPatch) {
