...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ResolutionRouteRemoval
 */
class ResolutionRouteRemoval extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentEntityId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteRemoval#ParentEntityId" (tag 1) is required but has no value.');
        }

        if ($this->RouteId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteRemoval#RouteId" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ResolutionRouteRemoval) {
