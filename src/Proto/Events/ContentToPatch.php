...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ContentToPatch
 */
class ContentToPatch extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setContent(\Antlena\SDK\Diadoc\Proto\Events\UnsignedContent $value)
    {
        $this->Content = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->TypeNamedId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ContentToPatch#TypeNamedId" (tag 1) is required but has no value.');
        }

        if ($this->Function === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ContentToPatch#Function" (tag 2) is required but has no value.');
        }

        if ($this->Version === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ContentToPatch#Version" (tag 3) is required but has no value.');
        }

        if ($this->Content === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ContentToPatch#Content" (tag 4) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ContentToPatch) {
