...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.MessageToSend
 */
class MessageToSend extends \Protobuf\AbstractMessage
{
     ...
     */
    public function addDocumentSignatures(\Antlena\SDK\Diadoc\Proto\Events\DocumentSignature $value)
    {
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->BoxId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\MessageToSend#BoxId" (tag 1) is required but has no value.');
        }

        if ($this->MessageId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\MessageToSend#MessageId" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\MessageToSend) {
