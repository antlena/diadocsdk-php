...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.XmlDocumentAttachment
 */
class XmlDocumentAttachment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\XmlDocumentAttachment#SignedContent" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\XmlDocumentAttachment) {
