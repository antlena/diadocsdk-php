...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.DocumentSenderSignature
 */
class DocumentSenderSignature extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentEntityId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\DocumentSenderSignature#ParentEntityId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\DocumentSenderSignature) {
