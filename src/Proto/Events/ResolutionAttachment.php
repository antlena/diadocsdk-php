...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ResolutionAttachment
 */
class ResolutionAttachment extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setResolutionType(\Antlena\SDK\Diadoc\Proto\Events\ResolutionType $value)
    {
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->InitialDocumentId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionAttachment#InitialDocumentId" (tag 1) is required but has no value.');
        }

        if ($this->ResolutionType === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionAttachment#ResolutionType" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ResolutionAttachment) {
