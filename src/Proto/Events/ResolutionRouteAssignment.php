...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.ResolutionRouteAssignment
 */
class ResolutionRouteAssignment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->InitialDocumentId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteAssignment#InitialDocumentId" (tag 1) is required but has no value.');
        }

        if ($this->RouteId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\ResolutionRouteAssignment#RouteId" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\ResolutionRouteAssignment) {
