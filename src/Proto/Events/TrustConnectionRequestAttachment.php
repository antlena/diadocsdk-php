...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.TrustConnectionRequestAttachment
 */
class TrustConnectionRequestAttachment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\TrustConnectionRequestAttachment#SignedContent" (tag 1) is required but has no value.');
        }

        if ($this->FileName === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Events\\TrustConnectionRequestAttachment#FileName" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\TrustConnectionRequestAttachment) {
