...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Events.EncryptedInvoiceMetadata
 */
class EncryptedInvoiceMetadata extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setRevisionDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Events\EncryptedInvoiceMetadata) {
