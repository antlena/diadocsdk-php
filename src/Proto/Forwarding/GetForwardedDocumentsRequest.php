...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Forwarding.GetForwardedDocumentsRequest
 */
class GetForwardedDocumentsRequest extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\Antlena\SDK\Diadoc\Proto\Forwarding\ForwardedDocumentId>
     */
     ...
     *
     * @return \Protobuf\Collection<\Antlena\SDK\Diadoc\Proto\Forwarding\ForwardedDocumentId>
     */
     ...
     *
     * @param \Protobuf\Collection<\Antlena\SDK\Diadoc\Proto\Forwarding\ForwardedDocumentId> $value
     */
     ...
     */
    public function addForwardedDocumentIds(\Antlena\SDK\Diadoc\Proto\Forwarding\ForwardedDocumentId $value)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Forwarding\GetForwardedDocumentsRequest) {
