...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Forwarding.ForwardDocumentRequest
 */
class ForwardDocumentRequest extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ToBoxId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Forwarding\\ForwardDocumentRequest#ToBoxId" (tag 1) is required but has no value.');
        }

        if ($this->DocumentId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Forwarding\\ForwardDocumentRequest#DocumentId" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Forwarding\ForwardDocumentRequest) {
