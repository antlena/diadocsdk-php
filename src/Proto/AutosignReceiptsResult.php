...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.AutosignReceiptsResult
 */
class AutosignReceiptsResult extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedReceiptsCount === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\AutosignReceiptsResult#SignedReceiptsCount" (tag 1) is required but has no value.');
        }

        if ($this->NextBatchKey === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\AutosignReceiptsResult#NextBatchKey" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\AutosignReceiptsResult) {
