...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.CloudSignFile
 */
class CloudSignFile extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Antlena\SDK\Diadoc\Proto\Content_v2
     */
     ...
     * Get 'Content' value
     *
     * @return \Antlena\SDK\Diadoc\Proto\Content_v2
     */
     ...
     */
    public function setContent(\Antlena\SDK\Diadoc\Proto\Content_v2 $value = null)
    {
        $this->Content = $value;
    }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\CloudSignFile) {
