...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.CustomDataItem
 */
class CustomDataItem extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Key === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\CustomDataItem#Key" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\CustomDataItem) {
