...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Documents.InvoiceDocument.InvoiceCorrectionRevisionMetadata
 */
class InvoiceCorrectionRevisionMetadata extends \Protobuf\AbstractMessage
{
    ...
    {
        $this->InvoiceCorrectionRevisionStatus = \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::UnknownInvoiceStatus();
     ...
     */
    public function setInvoiceCorrectionRevisionStatus(\Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message = new self();
        $values  = array_merge([
            'InvoiceCorrectionRevisionStatus' => \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::UnknownInvoiceStatus(),
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->OriginalInvoiceNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#OriginalInvoiceNumber" (tag 2) is required but has no value.');
        }

        if ($this->OriginalInvoiceDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#OriginalInvoiceDate" (tag 3) is required but has no value.');
        }

        if ($this->OriginalInvoiceCorrectionNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#OriginalInvoiceCorrectionNumber" (tag 6) is required but has no value.');
        }

        if ($this->OriginalInvoiceCorrectionDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#OriginalInvoiceCorrectionDate" (tag 7) is required but has no value.');
        }

        if ($this->TotalInc === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#TotalInc" (tag 8) is required but has no value.');
        }

        if ($this->TotalDec === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#TotalDec" (tag 9) is required but has no value.');
        }

        if ($this->VatInc === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#VatInc" (tag 10) is required but has no value.');
        }

        if ($this->VatDec === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#VatDec" (tag 11) is required but has no value.');
        }

        if ($this->Currency === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#Currency" (tag 12) is required but has no value.');
        }

        if ($this->ConfirmationDateTimeTicks === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#ConfirmationDateTimeTicks" (tag 13) is required but has no value.');
        }

        if ($this->InvoiceAmendmentFlags === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionRevisionMetadata#InvoiceAmendmentFlags" (tag 14) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->InvoiceCorrectionRevisionStatus = \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceCorrectionRevisionMetadata) {
