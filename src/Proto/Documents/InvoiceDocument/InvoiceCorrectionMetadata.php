...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Documents.InvoiceDocument.InvoiceCorrectionMetadata
 */
class InvoiceCorrectionMetadata extends \Protobuf\AbstractMessage
{
    ...
    {
        $this->InvoiceCorrectionStatus = \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::UnknownInvoiceStatus();
     ...
     */
    public function setInvoiceCorrectionStatus(\Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message = new self();
        $values  = array_merge([
            'InvoiceCorrectionStatus' => \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::UnknownInvoiceStatus(),
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->OriginalInvoiceNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#OriginalInvoiceNumber" (tag 2) is required but has no value.');
        }

        if ($this->OriginalInvoiceDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#OriginalInvoiceDate" (tag 3) is required but has no value.');
        }

        if ($this->TotalInc === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#TotalInc" (tag 6) is required but has no value.');
        }

        if ($this->TotalDec === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#TotalDec" (tag 7) is required but has no value.');
        }

        if ($this->VatInc === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#VatInc" (tag 8) is required but has no value.');
        }

        if ($this->VatDec === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#VatDec" (tag 9) is required but has no value.');
        }

        if ($this->Currency === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#Currency" (tag 10) is required but has no value.');
        }

        if ($this->ConfirmationDateTimeTicks === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#ConfirmationDateTimeTicks" (tag 11) is required but has no value.');
        }

        if ($this->InvoiceAmendmentFlags === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceCorrectionMetadata#InvoiceAmendmentFlags" (tag 12) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->InvoiceCorrectionStatus = \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceCorrectionMetadata) {
