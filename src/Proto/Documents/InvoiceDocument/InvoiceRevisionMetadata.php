...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Documents.InvoiceDocument.InvoiceRevisionMetadata
 */
class InvoiceRevisionMetadata extends \Protobuf\AbstractMessage
{
    ...
    {
        $this->InvoiceRevisionStatus = \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::UnknownInvoiceStatus();
     ...
     */
    public function setInvoiceRevisionStatus(\Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message = new self();
        $values  = array_merge([
            'InvoiceRevisionStatus' => \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::UnknownInvoiceStatus(),
        ], $values);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->OriginalInvoiceNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceRevisionMetadata#OriginalInvoiceNumber" (tag 2) is required but has no value.');
        }

        if ($this->OriginalInvoiceDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceRevisionMetadata#OriginalInvoiceDate" (tag 3) is required but has no value.');
        }

        if ($this->Total === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceRevisionMetadata#Total" (tag 4) is required but has no value.');
        }

        if ($this->Vat === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceRevisionMetadata#Vat" (tag 5) is required but has no value.');
        }

        if ($this->Currency === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceRevisionMetadata#Currency" (tag 6) is required but has no value.');
        }

        if ($this->ConfirmationDateTimeTicks === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceRevisionMetadata#ConfirmationDateTimeTicks" (tag 7) is required but has no value.');
        }

        if ($this->InvoiceAmendmentFlags === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\InvoiceDocument\\InvoiceRevisionMetadata#InvoiceAmendmentFlags" (tag 8) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->InvoiceRevisionStatus = \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceStatus::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\InvoiceDocument\InvoiceRevisionMetadata) {
