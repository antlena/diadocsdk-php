...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Documents.ConfirmationMetadata
 */
class ConfirmationMetadata extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ReceiptStatus === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\ConfirmationMetadata#ReceiptStatus" (tag 1) is required but has no value.');
        }

        if ($this->DateTimeTicks === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\ConfirmationMetadata#DateTimeTicks" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\ConfirmationMetadata) {
