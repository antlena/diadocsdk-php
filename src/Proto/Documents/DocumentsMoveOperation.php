...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Documents.DocumentsMoveOperation
 */
class DocumentsMoveOperation extends \Protobuf\AbstractMessage
{
     ...
     */
    public function addDocumentIds(\Antlena\SDK\Diadoc\Proto\DocumentId $value)
    {
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->BoxId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\DocumentsMoveOperation#BoxId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\DocumentsMoveOperation) {
