...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Documents.BilateralDocument.BasicDocumentMetadata
 */
class BasicDocumentMetadata extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Total === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\BilateralDocument\\BasicDocumentMetadata#Total" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\BilateralDocument\BasicDocumentMetadata) {
