...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Documents.BilateralDocument.PriceListMetadata
 */
class PriceListMetadata extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\BilateralDocument\PriceListMetadata) {
