...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Documents.UniversalTransferDocument.UniversalTransferDocumentMetadata
 */
class UniversalTransferDocumentMetadata extends \Protobuf\AbstractMessage
{
    ...
    {
        $this->DocumentStatus = \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus::UnknownDocumentStatus();
     ...
     */
    public function setDocumentStatus(\Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message = new self();
        $values  = array_merge([
            'DocumentStatus' => \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus::UnknownDocumentStatus(),
            'Vat' => null,
            'Grounds' => null,
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'default_value' => \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus::UnknownDocumentStatus()
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'Total',
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Total === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalTransferDocumentMetadata#Total" (tag 2) is required but has no value.');
        }

        if ($this->DocumentFunction === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalTransferDocumentMetadata#DocumentFunction" (tag 5) is required but has no value.');
        }

        if ($this->Currency === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalTransferDocumentMetadata#Currency" (tag 6) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentMetadata) {
