...
namespace Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument;

/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Documents.UniversalTransferDocument.UniversalCorrectionDocumentRevisionMetadata
 */
class UniversalCorrectionDocumentRevisionMetadata extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus
     */
     ...
     *
     * @return \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus
     */
     ...
     *
     * @param \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus $value
     */
    public function setDocumentStatus(\Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus $value)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.Antlena.SDK.Diadoc.Proto.Documents.UniversalTransferDocument.UniversalTransferDocumentStatus'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'TotalInc',
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentStatus === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#DocumentStatus" (tag 1) is required but has no value.');
        }

        if ($this->TotalInc === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#TotalInc" (tag 2) is required but has no value.');
        }

        if ($this->TotalDec === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#TotalDec" (tag 3) is required but has no value.');
        }

        if ($this->VatInc === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#VatInc" (tag 4) is required but has no value.');
        }

        if ($this->VatDec === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#VatDec" (tag 5) is required but has no value.');
        }

        if ($this->DocumentFunction === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#DocumentFunction" (tag 7) is required but has no value.');
        }

        if ($this->Currency === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#Currency" (tag 8) is required but has no value.');
        }

        if ($this->ConfirmationDateTimeTicks === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#ConfirmationDateTimeTicks" (tag 9) is required but has no value.');
        }

        if ($this->InvoiceAmendmentFlags === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#InvoiceAmendmentFlags" (tag 10) is required but has no value.');
        }

        if ($this->OriginalInvoiceNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#OriginalInvoiceNumber" (tag 11) is required but has no value.');
        }

        if ($this->OriginalInvoiceDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#OriginalInvoiceDate" (tag 12) is required but has no value.');
        }

        if ($this->OriginalInvoiceCorrectionNumber === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#OriginalInvoiceCorrectionNumber" (tag 15) is required but has no value.');
        }

        if ($this->OriginalInvoiceCorrectionDate === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentRevisionMetadata#OriginalInvoiceCorrectionDate" (tag 16) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->DocumentStatus = \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalTransferDocumentStatus::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Documents\UniversalTransferDocument\UniversalCorrectionDocumentRevisionMetadata) {
