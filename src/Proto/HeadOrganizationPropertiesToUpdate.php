...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.HeadOrganizationPropertiesToUpdate
 */
class HeadOrganizationPropertiesToUpdate extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setKpp(\Antlena\SDK\Diadoc\Proto\StringValue $value = null)
    {
        $this->Kpp = $value;
    }
     ...
     * @param \Antlena\SDK\Diadoc\Proto\StringValue $value
     */
    public function setFullName(\Antlena\SDK\Diadoc\Proto\StringValue $value = null)
    {
        $this->FullName = $value;
    }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\HeadOrganizationPropertiesToUpdate) {
