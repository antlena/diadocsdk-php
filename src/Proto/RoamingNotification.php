...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.RoamingNotification
 */
class RoamingNotification extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Success === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\RoamingNotification#Success" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\RoamingNotification) {
