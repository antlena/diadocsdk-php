...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.KeyValueStorage.KeyValueStorageApiGetRequest
 */
class KeyValueStorageApiGetRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\KeyValueStorage\KeyValueStorageApiGetRequest) {
