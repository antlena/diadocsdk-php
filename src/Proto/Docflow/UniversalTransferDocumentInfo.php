...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.UniversalTransferDocumentInfo
 */
class UniversalTransferDocumentInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Function === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Docflow\\UniversalTransferDocumentInfo#Function" (tag 5) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\UniversalTransferDocumentInfo) {
