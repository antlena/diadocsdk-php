...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.Entity
 */
class Entity extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setCreationTimestamp(\Antlena\SDK\Diadoc\Proto\Timestamp $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\Entity) {
