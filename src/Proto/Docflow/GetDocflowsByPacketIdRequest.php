...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.GetDocflowsByPacketIdRequest
 */
class GetDocflowsByPacketIdRequest extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->PacketId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Docflow\\GetDocflowsByPacketIdRequest#PacketId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\GetDocflowsByPacketIdRequest) {
