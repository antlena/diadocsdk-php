...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.BuyerTitleDocflow
 */
class BuyerTitleDocflow extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setBuyerTitleAttachment(\Antlena\SDK\Diadoc\Proto\Docflow\SignedAttachment $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\BuyerTitleDocflow) {
