...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Docflow.OutboundUniversalTransferDocumentDocflow
 */
class OutboundUniversalTransferDocumentDocflow extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\OutboundUniversalTransferDocumentDocflow) {
