...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.GetDocflowRequest
 */
class GetDocflowRequest extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Docflow\\GetDocflowRequest#DocumentId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\GetDocflowRequest) {
