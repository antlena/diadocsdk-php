...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.GetDocflowEventsRequest
 */
class GetDocflowEventsRequest extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Filter === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Docflow\\GetDocflowEventsRequest#Filter" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\GetDocflowEventsRequest) {
