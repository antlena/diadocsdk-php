...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.Signature
 */
class Signature extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setEntity(\Antlena\SDK\Diadoc\Proto\Docflow\Entity $value = null)
    {
        $this->Entity = $value;
    }
     ...
     */
    public function setVerificationResult(\Antlena\SDK\Diadoc\Proto\SignatureVerificationResult $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\Signature) {
