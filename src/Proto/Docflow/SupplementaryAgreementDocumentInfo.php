...
/**
 * Protobuf message :
 * Antlena.SDK.Diadoc.Proto.Docflow.SupplementaryAgreementDocumentInfo
 */
class SupplementaryAgreementDocumentInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\SupplementaryAgreementDocumentInfo) {
