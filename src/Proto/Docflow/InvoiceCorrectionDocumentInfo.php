...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.InvoiceCorrectionDocumentInfo
 */
class InvoiceCorrectionDocumentInfo extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setOriginalInvoiceDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
     ...
     * @param \Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value
     */
    public function setOriginalInvoiceCorrectionDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\InvoiceCorrectionDocumentInfo) {
