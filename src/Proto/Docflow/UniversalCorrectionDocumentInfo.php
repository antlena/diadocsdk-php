...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.UniversalCorrectionDocumentInfo
 */
class UniversalCorrectionDocumentInfo extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setOriginalDocumentDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
     ...
     * @param \Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value
     */
    public function setOriginalDocumentRevisionDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
     ...
     * @param \Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value
     */
    public function setOriginalDocumentCorrectionDateAndNumber(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Function === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Docflow\\UniversalCorrectionDocumentInfo#Function" (tag 7) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\UniversalCorrectionDocumentInfo) {
