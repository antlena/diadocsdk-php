...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.InboundInvoiceReceiptDocflow
 */
class InboundInvoiceReceiptDocflow extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setReceiptAttachment(\Antlena\SDK\Diadoc\Proto\Docflow\SignedAttachment $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\InboundInvoiceReceiptDocflow) {
