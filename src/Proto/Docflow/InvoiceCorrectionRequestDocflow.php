...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.InvoiceCorrectionRequestDocflow
 */
class InvoiceCorrectionRequestDocflow extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setCorrectionRequestAttachment(\Antlena\SDK\Diadoc\Proto\Docflow\SignedAttachment $value = null)
    {
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\InvoiceCorrectionRequestDocflow) {
