...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.Docflow.FetchedDocument
 */
class FetchedDocument extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setDocument(\Antlena\SDK\Diadoc\Proto\Docflow\DocumentWithDocflow $value)
    {
        $this->Document = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Document === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Docflow\\FetchedDocument#Document" (tag 1) is required but has no value.');
        }

        if ($this->IndexKey === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\Docflow\\FetchedDocument#IndexKey" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\Docflow\FetchedDocument) {
