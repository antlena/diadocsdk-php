...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.DocumentId
 */
class DocumentId extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->MessageId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\DocumentId#MessageId" (tag 1) is required but has no value.');
        }

        if ($this->EntityId === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\DocumentId#EntityId" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\DocumentId) {
