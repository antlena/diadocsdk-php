...
/**
 * Protobuf message : Antlena.SDK.Diadoc.Proto.ForeignAddress
 */
class ForeignAddress extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Country === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\ForeignAddress#Country" (tag 1) is required but has no value.');
        }

        if ($this->Address === null) {
            throw new \UnexpectedValueException('Field "\\Antlena\\SDK\\Diadoc\\Proto\\ForeignAddress#Address" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Antlena\SDK\Diadoc\Proto\ForeignAddress) {
